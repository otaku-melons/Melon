...
* _**Типизация локализацией**_ – вместо типов через страны используется язык оригинального контента по стандарту [ISO 639-3](https://iso639-3.sil.org/code_tables/639/data) (позволянт избежать частой путаницы между новеллами из США и Великобритании).
		...
		"123456": [
			{
				...
				"paragraphs": [
					...
					"<p>Второй абзац.</p>",
					"<p><blockquote data-name=\"Блок текста\"><p>Текст внутри блока.</p></blockquote></p>",
					"<p><img src=\"path_to_image.png\"></p>"
				],
				"footnotes": [
